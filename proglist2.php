...
<head>
	...
	<?php
        ...
        $query2 = mysqli_query($con, "SELECT * FROM ankets WHERE tag='programmer'");
    					...
    					<form action="proglist.php" method="POST">
    						<div class="row col-12  ">
	    						<div class="col-10 ">
	    							...
	    							<input style="display: none" type="" name="userid" value="<?php echo $stroka2['userid']?>">
