...
<head>
	...
	<?php
        ...
        $query2 = mysqli_query($con, "SELECT * FROM ankets WHERE userid='{$_POST['userid']}'");
	...
	<div class="  col-12 pt-5 " >
		<div class="row">
					...
					<div class="col-6">
						<div class="">
							...
							<div style="background: black">
								<h1 class="text" style="color: #E3643E; font-size: 35px"><?php echo $stroka2['name']?></h1>
							</div>	
							
							<h1 class="text" style="text-align: center; color: #E3643E; font-size: 20px">роль во команде</h1>
							<div style="background: black">
								<h1 class="text" style="color: #E3643E; font-size: 35px"><?php echo $stroka2['tag']?></h1>
							</div>
						</div>
					</div>
				</div>
				<div class="mt-2 bg-12" style="height: 100px;  ">
					<div class="row">
						...
						<div class="col-3 ml-3" style="background:#E3643E; height: 100px;"> ">
							...
							<h1 style="text-align: center; font-size:30px ; ">10000</h1>
						</div>
			...
			<div class="col-5 mt-2 border"style="border: 4px double #E66640; background: black; padding: 10px">
				<p  class="text" style="color:#E66640; font-size:38px ; ">
