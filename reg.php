...
<body>
	<div style="background-image: url(img/bg.jpg); height: 2000px; width: 1920px;">
    	...
    	<div class="col-6 mx-auto" style="padding-top: 300px;">
			<h1 class="text" style="color:#E66640; text-align: center; ">Зарегестрировать аккаунт</h1>
			<form action="insertreg.php" method="POST">
                ...
                <button style="color:#E66640; background: black; " class="btn mt-3 text">зарегестрировать</button>
			</form>
		</div>
	</div>
</body>
